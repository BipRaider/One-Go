...
func newPwReserValidator(db pwResetDB, hmac hash.HMAC) *pwResetValidator {
...
// type pwResetValFn1 func(*pwReset) error

// func runPwResetValFns(pwr *pwReset ,fns ...pwResetValFn1) error{
//     for _,fn :=range fns{
// 		if err := fn(pwr); err !=nil{
// 			return err
// 		}
